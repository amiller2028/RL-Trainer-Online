...
module.exports = function(grunt) {
	grunt.initConfig({
			...
			libCannon: {
				...
				options: {
					banner: '// Cannon.js - http://schteppe.github.io/cannon.js/' + grunt.util.linefeed +
							'// https://github.com/danielribeiro/cannon.js/' + grunt.util.linefeed,
			...
			libThree: {
				...
				options: {
					banner: '// three.js - http://github.com/mrdoob/three.js' + grunt.util.linefeed +
							'// https://github.com/mrdoob/three.js/tree/r61' + grunt.util.linefeed,
					preserveComments: false
				}
			},
			game: {
				...
				options: {
					banner: '// RLTrainerOnline - https://github.com/amiller2028/RL-Trainer-Online' + grunt.util.linefeed,
					preserveComments: false
				}
			}
		},
		concat: {
			...
			dist: {
				...
				dest: 'js/build/RLTrainerOnline.js'
			}
		}
	});
	...
	grunt.registerTask('create-game', ['uglify:libCannon', 'uglify:libDetector', 'uglify:libThree', 'uglify:game', 'concat']);
};
